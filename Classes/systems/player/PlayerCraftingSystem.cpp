...
void PlayerCraftingSystem::update(entt::registry& registry, float dt) {
    ...
    for (auto entity : view) {
        ...
        // 检测附近的工作台
        auto nearbyStations = detectNearbyStations(playerPos);
...
std::vector<StationType> PlayerCraftingSystem::detectNearbyStations(const cocos2d::Vec2& playerPos) {
    ...
    auto& blockWorld = gameManager->getBlockWorld();
