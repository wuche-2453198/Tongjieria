#ifndef __SKELETON_TEST_SCENE_H__
#define __SKELETON_TEST_SCENE_H__
...
class SkeletonTestScene : public cocos2d::Layer {
public:
...
#endif // __SKELETON_TEST_SCENE_H__
